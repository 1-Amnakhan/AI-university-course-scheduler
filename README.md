...
A Python-based course scheduling system that automatically generates conflict-free university timetables using Artificial Intelligence techniques.
...
4\. Load the course data and generate a timetable through the GUI.
...
The goal of this project is to automate university timetable generation while satisfying scheduling constraints and reducing manual effort.
